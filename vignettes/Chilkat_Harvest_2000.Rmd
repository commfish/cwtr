...
```{r example1}
library(cwtr)
cwtEst(N=c(33666, NA), n=7618, lambda=c(140, 138, 116, 116), m=1, theta=c(0.01886, 102.15))
```
...
```{r example2}
x <- cwtEst(N=c(33666, NA), n=7618, lambda=c(140, 138, 116, 116), m=1, theta=c(0.01886, 102.15))
summary(x)
```
